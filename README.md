...
[commanderdoc - v0.1.10](#readmemd) › [Globals](#globalsmd)

# commanderdoc - v0.1.10
...
### Usage
```bash
commanderdoc markdown [options] <sourcefile> [command]
```
### Options
...
### Usage
```bash
commanderdoc json [options] <sourcefile> [command]
```
### Options
* -e --exported \<`commanderObject`> Name of the exported commander object to inspect (default: `commander`)
* -o --out-file \<`outfile`> File to store markdown output (defaults to stdout)
...
*Defined in [index.ts:42](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L42)*
...
*Defined in [index.ts:41](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L41)*
...
*Defined in [index.ts:104](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L104)*
...
*Defined in [index.ts:173](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L173)*
...
*Defined in [index.ts:60](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L60)*
...
*Defined in [index.ts:53](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L53)*
...
*Defined in [index.ts:13](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L13)*
...
*Defined in [index.ts:7](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L7)*
...
*Defined in [index.ts:87](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L87)*
...
*Defined in [index.ts:81](https://github.com/rhdeck/commanderdoc/blob/d054b6d/src/index.ts#L81)*
